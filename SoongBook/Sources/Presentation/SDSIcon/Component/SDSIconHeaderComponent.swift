...
struct SDSIconHeaderComponent: Component {
...
extension SDSIconHeaderComponent {
    typealias ContentType = SDSIconHeaderView
...
final class SDSIconHeaderView: BaseView {
